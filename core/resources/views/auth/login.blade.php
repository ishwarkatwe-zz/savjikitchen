...
<!--                    <div class="checkbox checkbox-primary">
                ...
                <div class="social-auth-links">
                    <h6>- OR -</h6>
                    <a href="{{ url('/auth/facebook') }}" class=" btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign up using Facebook</a> | 
                    <a href="{{ url('/auth/google') }}" class="btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign up using Google+</a>
                </div>
            </div><!-- /.form-box -->
        </div><!-- /.register-box -->
    </div>
